export const DUMMY_DATA = [
  ...
  },
  {
    ...
    },
    {
      ...
      type: "Korean cuisine",
      photoURL: "https://aubreyskitchen.com/wp-content/uploads/2021/01/salmon-sashimi-recipe.jpg",
      id: 8,
      filter: "Korean",
      tag: ["High-protein", "<1 hour"],
      ingredients: [
        "5-6 oz salmon (sushi grade)",
        "1 tablespoon soy sauce",
        "1 taplespoon ponzu sauce",
        "1/4 teaspoon minced garlic",
      ],
      recipeInstructions: [
        "Cut salmon into thin rectangular slices",
        "Mix soy sauce and yuzu ponzu sauce",
        "Add minced garlic to sauce",
      ]
    },
    {
      dishName: "Tuna Sashimi",
      type: "Korean cuisine",
      photoURL: "https://ocwildseafood.com/cdn/shop/articles/Ahi_Tuna_Sashimi_Seafood_Recipe_1024x.jpg",
      id: 9,
      tag: ["High-protein", "<1 hour"],
      ingredients: [
        "5-6 oz tuna (sushi grade)",
        "1 tablespoon soy sauce",
        "1 taplespoon ponzu sauce",
        "1/4 teaspoon minced garlic",
      ],
      recipeInstructions: [
        "Cut tuna into thin rectangular slices",
        "Mix soy sauce and yuzu ponzu sauce",
        "Add minced garlic to sauce",
      ]
    },
    {
      dishName: "Yellowtail Sashimi",
      type: "Korean cuisine",
      photoURL: "https://honest-food.net/wp-content/uploads/2022/08/hamachi-sashimi-1169x1536.jpg",
      id: 10,
      tag: ["High-protein", "<1 hour"],
      ingredients: [
        "5-6 oz yellowtail (sushi grade)",
        "1 tablespoon soy sauce",
        "1 taplespoon ponzu sauce",
        "1/4 teaspoon minced garlic",
      ],
      recipeInstructions: [
        "Cut yellowtail into thin rectangular slices",
        "Mix soy sauce and yuzu ponzu sauce",
        "Add minced garlic to sauce",
      ],
    },
    {
      ...
      type: "Italian cuisine",
      photoURL: "https://www.onceuponachef.com/images/2019/09/Spaghetti-and-Meatballs.jpg",
      id: 11,
      tag: ["High-protein", "Budget-friendly"],
      ingredients: [
        "Equal parts beef, veal, and pork",
        "Parmesan",
        "Spaghetti noodles",
        "Tomato sauce",
        "Egg",
      ...
      recipeInstructions: [
        "Combine the egg, basil, parsley, oregano, salt, pepper, garlic and water; whisk well",
        "Add meat, breadcrumbs, Permesan to the mixture",
        "Mix all together",
        "Roll mixture into meatballs",
        "Bake for 10 minutes and flip them",
        "Bake for another 10 minutes until browned",
        "Cook meatball with the tomato sauce",
        "Cook noodles until al dente",
        "Drain, then toss with sauce and meatballs",
      ],
    },
];
